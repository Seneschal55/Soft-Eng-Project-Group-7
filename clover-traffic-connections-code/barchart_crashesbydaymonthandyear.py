...
filtered_df = filtered_df.sort_values(by=['Injury Type'], ascending=[True]).head().reset_index()
...
# Creating sum of number of crashes group
new_df3 = filtered_df.groupby(['Day'])['Injury Type'].count().reset_index()
new_df3 = new_df3.sort_values(by=['Injury Type'], ascending=[True]).head().reset_index()
