...
fig.update_xaxes(title_text="Number of Crashes with Injuries", row=1, col=1)
fig.update_xaxes(title_text="Number of Crashes with Injuries", row=2, col=1)
fig.update_yaxes(title_text="Primary Factor", row=1, col=1)
fig.update_yaxes(title_text="Street", row=2, col=1)
